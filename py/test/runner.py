...
class IinLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IinLookupTestRunner.getenv("IINLOOKUP_TEST_LIVE")
        override = IinLookupTestRunner.getenv("IINLOOKUP_TEST_OVERRIDE")
        ...
        explain = IinLookupTestRunner.getenv("IINLOOKUP_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["IINLOOKUP_TEST_EXPLAIN"] = explain
