# IinLookup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IinLookupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IinLookupSDK(...) and IinLookupSDK.test(...) become
#      IinLookupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "iinlookup_sdk"
_SDK_CLASS = "IinLookupSDK"
