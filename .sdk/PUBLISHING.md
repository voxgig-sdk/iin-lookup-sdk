...
|---|---|---|
| `ts/` | @voxgig-sdk/iin-lookup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/iin-lookup-sdk \
      --repository voxgig-sdk/iin-lookup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/iin-lookup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/iin-lookup-sdk --id=<id>` removes it.
