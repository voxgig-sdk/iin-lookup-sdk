...
class IinLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IinLookupTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IinLookupTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IinLookupTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
