...
class IinLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IinLookupTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IinLookupTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IinLookupTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
