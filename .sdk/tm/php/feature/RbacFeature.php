...
class IinLookupRbacFeature extends IinLookupBaseFeature
{
    ...
    private function _required(IinLookupContext $ctx): ?string
    {
    ...
    private function _reject(IinLookupContext $ctx, string $required): void
    {
    ...
    private function _track(IinLookupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
