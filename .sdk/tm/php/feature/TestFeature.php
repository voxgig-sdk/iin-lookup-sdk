...
// IinLookup SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IinLookupTestFeature extends IinLookupBaseFeature
{
    ...
    public function init(IinLookupContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IinLookupContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IinLookupParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IinLookupContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IinLookupContext $ctx, $op, $args): array
    {
