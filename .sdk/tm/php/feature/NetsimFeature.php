...
class IinLookupNetsimFeature extends IinLookupBaseFeature
{
    ...
    private function _simulate(IinLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IinLookupContext $ctx, array $applied): void
    {
        $client = $this->client;
