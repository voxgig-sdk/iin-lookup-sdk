...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = IinLookupOmni.make_runner(TEST_JSON_FILE, IinLookupSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : IinLookupOmni.errify(err)
    end
