...
func (sdk *IinLookupSDK) OptionsMap() map[string]any {
...
func (sdk *IinLookupSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IinLookupSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IinLookupSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IinLookupSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IinLookupSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IinLookupSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IinLookupSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IinLookupSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IinLookupSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IinLookupSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
