...
## Install
```bash
go get github.com/voxgig-sdk/iin-lookup-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/iin-lookup-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/iin-lookup-sdk/go=../iin-lookup-sdk/go
```
...
| `Overview` | `(data map[string]any) IinLookupEntity` | Create an Overview entity instance. |
...
fmt.Println(overview) // the loaded record
```
