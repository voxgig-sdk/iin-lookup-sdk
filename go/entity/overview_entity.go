...
func NewOverviewEntity(client *core.IinLookupSDK, entopts map[string]any) *OverviewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OverviewEntity) GetName() string { return e.name }
...
func (e *OverviewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OverviewEntity) Deleted() bool {
	return e.deleted
}


func (e *OverviewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOverviewEntity(e.client, opts)
}

func (e *OverviewEntity) Data(args ...any) any {
...
func (e *OverviewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Overview; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OverviewEntity) DataTyped(data ...Overview) Overview {
	if len(data) > 0 {
		return typedFrom[Overview](e.Data(asMap(data[0])))
	}
	return typedFrom[Overview](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Overview (all fields
// optional at the wire level).
func (e *OverviewEntity) MatchTyped(match ...Overview) Overview {
	if len(match) > 0 {
		return typedFrom[Overview](e.Match(asMap(match[0])))
	}
	return typedFrom[Overview](e.Match())
}
...
func (e *OverviewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OverviewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OverviewLoadMatch and returns an Overview. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OverviewEntity) LoadTyped(reqmatch OverviewLoadMatch, ctrl map[string]any) (Overview, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Overview{}, err
	}
	return typedFrom[Overview](res), nil
}



func (e *OverviewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OverviewEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// OverviewCreateData and returns an Overview. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OverviewEntity) CreateTyped(reqdata OverviewCreateData, ctrl map[string]any) (Overview, error) {
...
func (e *OverviewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OverviewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OverviewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
