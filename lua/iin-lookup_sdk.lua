...
local IinLookupSDK = {}
IinLookupSDK.__index = IinLookupSDK
...
IinLookupSDK._make_feature = _make_feature


function IinLookupSDK.new(options)
  local self = setmetatable({}, IinLookupSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IinLookupSDK:options_map()
...
function IinLookupSDK:get_utility()
  return Utility.copy(self._utility)
end


function IinLookupSDK:get_root_ctx()
  return self._rootctx
end


function IinLookupSDK:prepare(fetchargs)
...
function IinLookupSDK:direct(fetchargs)
...
-- by passing it.
function IinLookupSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IinLookupSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IinLookupSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IinLookupSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IinLookupSDK.new(sdkopts)
  sdk.mode = "test"
