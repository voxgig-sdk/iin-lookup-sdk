...
describe("OverviewDirect", function()
  it("should direct-load-overview", function()
    local setup = overview_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-overview", setup.live and "live" or "unit")
...
function overview_direct_setup(mockres)
