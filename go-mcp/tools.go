...
type Args struct {
	Entity string         `json:"entity" jsonschema:"overview"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IinLookupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "iin-lookup_list",
		Description: "List records from IinLookup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "iin-lookup_load",
		Description: "Load a single record from IinLookup. " +
...
func runOp(client *sdk.IinLookupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IinLookupSDK, name string) (sdk.IinLookupEntity, error) {
	switch strings.ToLower(name) {
	case "overview":
		return client.Overview(nil), nil
