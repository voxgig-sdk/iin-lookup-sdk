...
(0, node_test_1.describe)('OverviewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IinLookupSDK({
    ...
    (0, node_test_1.test)('direct-load-overview', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-overview', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IinLookupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            server: {
                base_url: env.IIN_LOOKUP_SERVER_BASE_URL,
            },
        }));
        let idmap = env['IIN_LOOKUP_TEST_OVERVIEW_ENTID'];
    ...
    const client = new __1.IinLookupSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OverviewDirect.test.js.map