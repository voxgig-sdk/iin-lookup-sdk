...
function envOverride(m) {
    if ('TRUE' === process.env.IIN_LOOKUP_TEST_LIVE ||
        'TRUE' === process.env.IIN_LOOKUP_TEST_OVERRIDE) {
    ...
    m.IIN_LOOKUP_TEST_EXPLAIN = process.env.IIN_LOOKUP_TEST_EXPLAIN || m.IIN_LOOKUP_TEST_EXPLAIN;
    return m;
}
