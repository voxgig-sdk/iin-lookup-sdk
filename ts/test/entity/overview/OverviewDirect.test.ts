...
describe('OverviewDirect', async () => {
  ...
  test('direct-load-overview', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-overview', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IIN_LOOKUP_TEST_OVERVIEW_ENTID']
