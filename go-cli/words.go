...
func registerSDKWords(r *eng.Registry, client *sdk.IinLookupSDK) {
...
func runOp(client *sdk.IinLookupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
