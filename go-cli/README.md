...
AQL-driven CLI and REPL for the IinLookup SDK. Positional arguments are
...
./iin-lookup-cli list overview
./iin-lookup-cli load 1 overview
./iin-lookup-cli load '{id:1}' overview
