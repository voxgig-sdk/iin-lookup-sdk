...
// IinLookup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IinLookupSDK::test)
...
{
    private const SDK_CLASS = 'IinLookupSDK';
    ...
    private const SDK_BASE = 'iinlookup_sdk';
