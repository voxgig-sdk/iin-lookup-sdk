...
class IinLookupTestRunner
{
    ...
    {
        $live = self::getenv('IIN_LOOKUP_TEST_LIVE');
        $override = self::getenv('IIN_LOOKUP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IIN_LOOKUP_TEST_EXPLAIN');
...
class_alias('IinLookupTestRunner', 'Runner');
class_alias('IinLookupHelpers', 'Helpers');
