...
class IinLookupProxyFeature extends IinLookupBaseFeature
{
    ...
    public function init(IinLookupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IinLookupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
