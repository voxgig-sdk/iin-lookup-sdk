...
// IinLookup SDK clienttrack feature
...
class IinLookupClienttrackFeature extends IinLookupBaseFeature
{
    ...
    public function PostConstruct(IinLookupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IinLookup-SDK';
