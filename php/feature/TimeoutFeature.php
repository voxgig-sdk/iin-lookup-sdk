...
class IinLookupTimeoutFeature extends IinLookupBaseFeature
{
    ...
    private function _with_timeout(IinLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IinLookupContext $_ctx, float $ms): void
    {
        $client = $this->client;
