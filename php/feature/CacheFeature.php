...
class IinLookupCacheFeature extends IinLookupBaseFeature
{
    ...
    private function _through(IinLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
