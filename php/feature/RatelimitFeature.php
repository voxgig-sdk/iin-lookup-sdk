...
// IinLookup SDK ratelimit feature
...
class IinLookupRatelimitFeature extends IinLookupBaseFeature
{
    ...
    private function _acquire(IinLookupContext $ctx): void
    {
    ...
    private function _track(IinLookupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
