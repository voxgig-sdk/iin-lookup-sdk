...
// IinLookup SDK streaming feature
...
class IinLookupStreamingFeature extends IinLookupBaseFeature
{
    ...
    private function _iterate(IinLookupResult $result): \Generator
    {
    ...
    private function _streamable(IinLookupContext $ctx): bool
    {
