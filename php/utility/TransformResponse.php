...
// IinLookup SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IinLookupTransformResponse
{
    public static function call(IinLookupContext $ctx): mixed
    {
        ...
        $transform = IinLookupHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
