...
class IinLookupGraphql
{
    ...
    // equivalent.
    public static function body(IinLookupContext $ctx): mixed
    {
    ...
    public static function errors(IinLookupContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
