...
// IinLookup SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IinLookupMakeRequest
{
    public static function call(IinLookupContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IinLookupResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IinLookupResponse($fetched);
        } else {
