...
// IinLookup SDK utility: fetcher

class IinLookupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IinLookupSDK/1.0)';
    ...
    public static function call(IinLookupContext $ctx, string $fullurl, array $fetchdef): array
    {
